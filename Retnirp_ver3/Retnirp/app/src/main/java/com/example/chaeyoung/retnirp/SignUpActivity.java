...
public class SignUpActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_confirm = (EditText) findViewById(R.id.edittext_confirmation);
    }
    ...
    public void confirmOnclick(View v){
        ...
        if(!checkid){//did not check id
            ...
            toast.makeText(this, "Please check ID first", Toast.LENGTH_SHORT).show();
            return ;
        }

        //chceck password comfirmation
        if( !(edit_pw.getText().toString().equals(edit_confirm.getText().toString()))){// do not match password and confirmation
